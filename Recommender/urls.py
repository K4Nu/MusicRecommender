...
from users.views import SpotifyConnect,UserTopTracks,TestView,YoutubeConnect,TestLastFM,SpotifyAccountDisconnect, DeleteAccountView
...
urlpatterns = [
    ...
    path("auth/spotify/disconnect/",SpotifyAccountDisconnect.as_view()),
